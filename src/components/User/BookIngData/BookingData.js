...
import BookingDataDetail from '../BookingDataDetail/BookingDataDetail';
...
const BookingData = () => {
    ...
    useEffect(() => {
        fetch('https://arcane-caverns-85014.herokuapp.com/orders?email=' + loggedInUser.email)
            .then(res => res.json())
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <table class="table">
                                            ...
                                            {
                                                list.map(listDetails => <BookingDataDetail listDetails={listDetails}></BookingDataDetail>)
                                            }
                                        </table>
                                    </div>
                                </div>
